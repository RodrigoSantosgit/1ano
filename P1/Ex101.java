...
// FUNCOES ##########################################################
 ...
 public static void ordseq(int a[]) {
	 int tmp=0, i, j;
 ...
 public static void ordflut(int a[]) {
	 boolean trocas;
	 int i, tmp;
	 do{
		 trocas=false;
 ...
 public static void pesqvalor(int a[], int valor) {
	 int pos =-1;
	 int n=0;
	 do{
		if(a[n]==valor){
			pos=n;
			System.out.printf("O valor esta na posicao %d, (a[%d] = %d)\n", valor, pos, valor);
		}
		n++;
	 }while(pos==-1 && n<a.length);
 }
}
