...
public class KeyValueList<E> {
  ...
  public String toString(String left, String sep, String right) {
    ...
    //...
    return "{" + toString(left, sep, right, first) + "}";
  }
  public String toString(String left, String sep, String right, KeyValueNode<E> n) {
	if(!n.key.equals(null)){
		if(!n.key.equals(left))
			toString( left, sep, right, n.next);
		return "(" + n.key + "," + n.elem + ")" + ";" + toString(left, sep, right, n.next);
	}
	return "";
  }
