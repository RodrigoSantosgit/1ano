...
public class Sorting {
  ...
  @SuppressWarnings("unchecked")
  public static void mergeArrays(int[] a, int start, int middle, int end){
  ...
  @SuppressWarnings("unchecked")
  public static <E extends Comparable<E>> void mergeArrays(E[] a, int start, int middle, int end){
